          ...
          <div style={{
            ...
            <div style={{
              ...
              <h3 style={{
                ...
                Что такое голосовые и чат-боты?
              </h3>
              <p style={{
                color: '#6b7280',
                lineHeight: '1.6',
                ...
                Голосовые и чат-боты — это AI-ассистенты, которые автоматически обрабатывают запросы клиентов через голосовые звонки и текстовые сообщения. Они работают 24/7, отвечают на вопросы, помогают с выбором услуг и конвертируют посетителей в клиентов.
              </p>
            </div>
            ...
            <div style={{
              ...
              <h3 style={{
                ...
                Какие задачи решают голосовые и чат-боты?
              </h3>
              <p style={{
                color: '#6b7280',
                lineHeight: '1.6',
                ...
                Наши боты решают широкий спектр задач: консультируют клиентов, принимают заказы, отвечают на часто задаваемые вопросы, собирают контактные данные, записывают на консультации, помогают с выбором услуг и обеспечивают круглосуточную поддержку.
              </p>
            </div>
            ...
            <div style={{
              ...
              <p style={{
                ...
                Голосовые боты используют технологии распознавания речи (ASR) и синтеза речи (TTS). Они понимают естественную речь клиентов, обрабатывают запросы с помощью AI, формируют ответы и озвучивают их естественным голосом, создавая ощущение общения с живым оператором.
              </p>
            </div>
          </div>
